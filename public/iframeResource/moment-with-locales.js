(function (global, factory) {
  ...
  function dayOfYearFromWeekInfo(config) {
      let w; let weekYear; let week; let weekday; let dow; let doy; let temp; let weekdayOverflow; let curWeek
  ...
  function diff(input, units, asFloat) {
      let that; let zoneDelta; let output
  ...
  let token; let getSetMillisecond
