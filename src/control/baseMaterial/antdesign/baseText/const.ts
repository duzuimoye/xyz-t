...
export const iconDirectionOptions = [
  { label: i18n.t('baseMateiral.baseText.iconDirectionOptions.left'), value: 'left' },
  { label: i18n.t('baseMateiral.baseText.iconDirectionOptions.right'), value: 'right' }
]
...
export const shapeOptinos = [
  { label: i18n.t('baseMateiral.baseText.shapeOptions.default'), value: 'default' },
  { label: i18n.t('baseMateiral.baseText.shapeOptions.round'), value: 'round' },
  { label: i18n.t('baseMateiral.baseText.shapeOptions.circle'), value: 'circle' }
]